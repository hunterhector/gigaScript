 ...
 *    <LI>the user may directly call the {@link #stepUntil( it.unimi.dsi.law.rank.PageRank.StoppingCriterion)} method, which iterates
 *      a call to {@link #step()} method until a certain stopping criterion is met; a {@link it.unimi.dsi.law.rank.PageRank.StoppingCriterion}
 *      is a class that may decide if the iteration can be stopped (on the basis of a certain {@link it.unimi.dsi.law.rank.PageRank} object).
 *		The {@link it.unimi.dsi.law.rank.PageRank} class also provides two ready-to-use implementations of stopping criteria:
 * 		<UL>
 *          <LI>{@linkplain it.unimi.dsi.law.rank.PageRank.NormDeltaStoppingCriterion one} that decides whether to stop depending on whether
 ...
 *          <LI>{@linkplain it.unimi.dsi.law.rank.PageRank.IterationNumberStoppingCriterion another} that decides whether to stop on the basis of the number of iterations.
 * 		</UL>
 *
 *   <P>Moreover, the {@link it.unimi.dsi.law.rank.PageRank} class provides two static methods to compose two stopping criteria in a {@linkplain #and( it.unimi.dsi.law.rank.PageRank.StoppingCriterion, it.unimi.dsi.law.rank.PageRank.StoppingCriterion) conjunctive}
 *      or {@linkplain #or( it.unimi.dsi.law.rank.PageRank.StoppingCriterion, it.unimi.dsi.law.rank.PageRank.StoppingCriterion) disjunctive} way.
 *  </UL>
 *
 ...
 *  dangling nodes adding transitions es.yrbcn.graph.weighted following the preference vector <var><b>v</b></var>.
...
//		 Reads sum of out-weights in main memory
	 ...
	 * @throws java.io.IOException if an exception occurs during computation.
	 */
